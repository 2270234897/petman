...
export function SimpleTreeSelect({ 
  categories, 
  value, 
  onValueChange, 
  placeholder = "请选择分类",
  ...
  const selectedCategory = useMemo(() => {
    ...
    console.log('SimpleTreeSelect - selectedCategory:', found, 'value:', value)
    return found
  }, [value, categoryTree])
  ...
  const handleCategorySelect = (categoryId: number) => {
    console.log('SimpleTreeSelect - handleCategorySelect:', categoryId)
